...
export default function Index() {
  ...
  return (
    <>
      ...
      <p>A graduate of Universitas Negeri Jakarta who is currently undertaking her studies at the St&auml;delschule, Rupaidha has consistently pushed the boundaries of how digital tools and conceptual art can converge. Her practice incorporates multi-channel video, installations, generative visuals, and interactive elements, often challenging viewers in how they experience presence, history, and truth in a hyperconnected world.</p>
